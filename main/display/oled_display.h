...
private:
    ...
    lv_obj_t *screen_eye_ = nullptr;
    lv_obj_t *screen_eye_eyes_ = nullptr;
    lv_obj_t *screen_eye_status_bar_ = nullptr;
    lv_obj_t *screen_eye_status_label_ = nullptr;
...
public:
    ...
    virtual void SetEmotion(unsigned char emotion) override;
    virtual void SetTheme(Theme *theme) override;
    inline RoboEyes *GetEyes() { return eyes_; };
    inline Face *GetFace() { return face_; };
};
